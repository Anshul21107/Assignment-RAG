...
def main():
    ...
    st.markdown("""
        <h1 style='text-align: center;'>Ask Chatbot!</h1>
    ...
    if prompt:
        ...
        Use the pieces of information provided in the context to answer the user's question as clearly and factually as possible.
        Do not speculate, generate generic advice, or include writing suggestions.
        Only use the given context. If the answer is not in the context, just say "I don't know."
